        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-lg sm:rounded-xl p-4 sm:p-6 sticky top-4">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            {promo && (
              <p className="text-xs text-green-400 mt-2 mb-0">
                ✓ {t("code")} "{promo.code}" {t("codeApplied")} (
                {promo.discount}% {t("discount")})
                <button
          ...
          <div className="space-y-3 mb-6 pb-6 border-b border-gray-700">
            <div className="flex justify-between text-sm sm:text-base">
              <span className="text-gray-400 m-0">{t("subtotal")}</span>
            ...
            {promo && (
              <div className="flex justify-between text-sm sm:text-base">
                <span className="text-green-400 m-0">{t("promoDiscount")}</span>
            ...
            <div className="flex justify-between text-sm sm:text-base">
              <span className="text-gray-400 m-0">{t("tax")} (10%)</span>
              <span className="text-white font-semibold m-0">
                ${tax.toFixed(2)}
              </span>
            </div>
          ...
          <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-700">
            <p className="text-xs text-gray-400 mb-3 text-center m-0">
              {t("weAccept")}
            </p>
