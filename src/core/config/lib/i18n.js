  ...
  i18n.use(initReactI18next).init({
    resources: {
      en: {
        translation: {
          // basket
          titleBasket: "Shopping Basket", //-
          itemsInBasket: "in your basket",
          empty: "Your basket is empty",
          emptyMessage: "Add some games to get started!",
          itemTotal: "Item Total",
          titleRemove: "Remove Item?", //-
          messageRemove: "Are you sure you want to remove ",
          from: "from your basket? ",
          ...
          welcomeMessage:
            "Welcome to Game Store, your trusted destination for the latest and most exciting games. We bring you top-quality titles, exclusive deals, and a smooth shopping experience. Stay connected for updates, offers, and endless fun.",
      ...
      az: {
        translation: {
          //basket
          titleBasket: "Alış-veriş Səbəti",
          itemsInBasket: "səbətinizdə",
          empty: "Səbətiniz boşdur",
          emptyMessage: "Başlamaq üçün oyunlar əlavə edin!",
          itemTotal: "Məhsul Cəmi",
          titleRemove: "Məhsul Silinsin?",
          messageRemove: "Səbətdən silmək istədiyinizə əminsiniz?",
          from: "",
          warning: " Bu əməliyyat geri qaytarıla bilməz",
          keep: "Xeyr, Saxla",
          confirm: "Bəli, Sil",
          ...
          codeApplied: "tətbiq edildi",
          discount: "endirim",
          remove: "sil",
          subtotal: "Ara Cəm",
          promoDiscount: "Promosyon Endirimi",
          tax: "ƏDV",
          total: "Cəmi",
          checkout: "Ödənişə Keç",
          weAccept: "Qəbul edilən ödəniş üsulları",
          ...
          enterEmailToReset:
            "Parolunuzu sıfırlamaq üçün e-poçtunuzu daxil edin",
          ...
          welcomeMessage:
            "Game Store-a xoş gəlmisiniz, ən son və həyəcanverici oyunlar üçün etibarlı təyinatınız. Biz sizə yüksək keyfiyyətli başlıqlar, ekskluziv təkliflər və hamar alış-veriş təcrübəsi təqdim edirik. Yeniləmələr, təkliflər və sonsuz əyləncə üçün əlaqədə qalın.",
      ...
      tr: {
        translation: {
          //basket
          titleBasket: "Alışveriş Sepeti",
          itemsInBasket: "sepetinizde",
          empty: "Sepetiniz boş",
          emptyMessage: "Başlamak için oyunlar ekleyin!",
          itemTotal: "Ürün Toplamı",
          titleRemove: "Ürün Kaldırılsın mı?",
          messageRemove: "Sepetden kaldırmak istediğinizden emin misiniz?",
          from: "",
          ...
          weAccept: "Kabul edilen ödeme yöntemleri",
          ...
          welcomeMessage:
            "Game Store'a hoş geldiniz, en son ve heyecan verici oyunlar için güvenilir hedefiniz. Size yüksek kaliteli başlıklar, özel teklifler ve sorunsuz alışveriş deneyimi sunuyoruz. Güncellemeler, teklifler ve sonsuz eğlence için bağlantıda kalın.",
